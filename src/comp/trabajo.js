            ...
            <div className="Trabajo">
                ...
                <Grid container direction="row"
                    ...
                    <Grid item sm={9} xs={12}>
                        ...
                        De el total de 8 años que llevo trabajando en CETIUC 4 fueron de forma presencial y 4 son de forma remota,
                        ...
                        <li>Mantener opertativa la infraestructura (aws,ecs,dominios,servidores svn y apache).</li>
                        </ul>
                    </Grid>
                    <Grid item sm={3} xs={12}>
