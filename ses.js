...
function pintaProd(o,variables){
  ...
  const elementsContainer = document.querySelector("#content-${dyVariationId}");
...
function dyPodImage(o,pod){
  // /<img class="blockRecomendationMainImg-${dyVariationId}" src="`+scene7Url+ o.sku +` "alt="`+ o.titulo +` `+ o.marca +`" title="`+ o.titulo +` `+ o.marca +`"" />
  const img = document.createElement('img');
  img.classList.add('dy-pod-img');
  img.setAttribute('src',scene7Url+ o.sku+ "?${scene7 Image Options}");
